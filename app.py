...
PREDICTED_LABELS = ["Bee", "Caterpillar", "Snail", "Slug", "Wasp", "Weevil", "Moth"]
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/d32affc5-84b4-42d5-8d0c-c384ce21ea23'
...
st.title("Pest Detector")#change according to your project
